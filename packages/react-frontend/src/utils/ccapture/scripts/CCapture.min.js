!(function () {
  ...
  function m(t) {
    ...
    function v(t) {
      t ||
        (t = function (t) {
          return download(t, O.filename + O.extension, O.mimeType), !1;
        }),
        O.save(t);
    }
    function b(t) {
  ...
  var d = { function: !0, object: !0 },
    u =
      (parseFloat,
      parseInt,
      d[typeof exports] && exports && !exports.nodeType ? exports : void 0),
    ...
    b =
      w || (g !== (v && v.window) && g) || y || v || Function("return this")();
