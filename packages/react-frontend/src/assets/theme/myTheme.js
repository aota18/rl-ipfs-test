const myTheme = {
  ...
  // Badge
  badge: {
    base: "inline-flex px-4 text-xs font-medium leading-5 rounded-full text-white",
    success:
    ...
    primary: "text-white bg-primary dark:text-white dark:bg-primary",
  },
  // Backdrop
  backdrop: {
  ...
  input: {
    ...
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200",
    radio:
      "text-green-500 form-radio  focus:ring-offset-0 dark:focus:ring-gray-300",
    checkbox: "text-green-500 form-checkbox rounded dark:focus:ring-gray-300",
  },
  // HelperText
  helperText: {
    base: "text-xs",
  ...
  // Button
  button: {
    base: "align-bottom h-12 inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none",
    block: "w-full",
    size: {
    ...
    primary: {
      base: "text-white bg-primary border-none",
      active:
    ...
    outline: {
      ...
      active:
        "rounded-lg border border-gray-200 px-4 cursor-pointer h-12 bg-gray-200",
      disabled: "opacity-50 cursor-not-allowed bg-gray-300",
    },
    link: {
      base: "text-gray-600 dark:text-gray-400 focus:outline-none border border-none border-transparent",
      active:
        "active:bg-transparent dark:hover:text-gray-300 dark:hover:bg-opacity-10",
      disabled: "opacity-50 cursor-not-allowed",
    },
